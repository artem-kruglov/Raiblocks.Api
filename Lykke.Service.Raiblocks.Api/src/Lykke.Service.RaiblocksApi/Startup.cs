...
namespace Lykke.Service.RaiblocksApi
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            try
            {
                ...
                {
                    options.DefaultLykkeConfiguration("v1", "RaiblocksApi API");
                });
                ...
                builder.RegisterModule(new ServiceModule(appSettings.Nested(x => x.RaiblocksApiService), Log));
        ...
        private static ILog CreateLogWithSlack(IServiceCollection services, IReloadingManager<AppSettings> settings)
        {
            ...
            var dbLogConnectionStringManager = settings.Nested(x => x.RaiblocksApiService.Db.LogsConnString);
            ...
            var persistenceManager = new LykkeLogToAzureStoragePersistenceManager(
                AzureTableStorage<LogEntity>.Create(dbLogConnectionStringManager, "RaiblocksApiLog", consoleLogger),
                consoleLogger);
